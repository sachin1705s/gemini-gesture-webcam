...
class GeminiWorker:
    def __init__(self, client: genai.Client):
        ...
        self.last_result = (None, "waiting...", None, None)  # (frame, text, latency_ms, ts)
    ...
    def _run(self):
        while not self.stop_flag:
            ...
            with self.lock:
                self.last_result = (frame, text, latency_ms, ts)
...
async def main():
    ...
    try:
        while True:
            ...
            processed_frame, last_text, latency_ms, ts = worker.get_last()
